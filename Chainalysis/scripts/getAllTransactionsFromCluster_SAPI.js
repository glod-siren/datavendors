...
const config = {
    ...
    titleText: "Chainalysis IAPI - Cluster Transactions",
    destination: "Cluster Transactions",
    WSName: 'chainalysis-iapi',
    WSType: 'address_transactions',
    WSStoreData: true,
    WSReturnData: true,
            ...
            await Promise.all(collectedAddresses.map(async address => {
                ...
                if (invocation.data.pagination[0].nextPage !== '' && invocation.data.pagination[0].nextPage !== null) {
                    ...
                    do {
                        ...
                        counter++
                    } while (lastPagination !== '' && lastPagination !== null && counter < 30)
                    if (lastPagination !== '') {
